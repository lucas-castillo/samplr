...
---
This branch makes cpp functions for MCMC algorithms available. They are not documented. We recommend not using them directly, but using their .R wrappers instead (as you would when using the samplr/main branch or from CRAN). 

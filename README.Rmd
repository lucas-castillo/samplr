...
2. A Fortran compiler. An installer for gfortran is available [here](https://github.com/fxcoudert/gfortran-for-macOS/releases/download/8.2/gfortran-8.2-Mojave.dmg.81). This installs into `/usr/local/gfortran`.

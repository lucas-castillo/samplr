...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Zhu23ABS_cpp(task_id, trial_stim, distr_name, proposal_width, n_chains, provided_start_point, stop_rule, nd_time, s_nd_time, lambda, prior_on_resp, prior_depend, mc3_iterations, dec_bdry, discrim));

...
Zhu23ABS_cpp <- function(task_id, start_point, distr_name, trial_stim, proposal_width, n_chains, prior_on_resp, stop_rule, nd_time, s_nd_time, er_lambda, mc3_iterations = 100L, dec_bdry = 0, discrim = 0) {
    .Call(`_samplr_Zhu23ABS_cpp`, task_id, start_point, distr_name, trial_stim, proposal_width, n_chains, prior_on_resp, stop_rule, nd_time, s_nd_time, er_lambda, mc3_iterations, dec_bdry, discrim)
}

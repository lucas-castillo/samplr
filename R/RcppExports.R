...
LiABS_tafc_cpp <- function(distr_name, proposal_width, n_chains, start_point, dec_bdry, discrim, delta, nd_time, s_nd_time, er_lambda, trial_fdbk, mc3_iterations) {
    .Call(`_samplr_LiABS_tafc_cpp`, distr_name, proposal_width, n_chains, start_point, dec_bdry, discrim, delta, nd_time, s_nd_time, er_lambda, trial_fdbk, mc3_iterations)
}

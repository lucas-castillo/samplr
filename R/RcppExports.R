...
ABS_sampler_cpp <- function(start_point, trial_fdbk, distr_name, n_chains, dec_bdry, d_sepn, delta, nd_time, s_nd_time, er_lambda, mc3_iterations, proposal_width) {
    .Call(`_samplr_ABS_sampler_cpp`, start_point, trial_fdbk, distr_name, n_chains, dec_bdry, d_sepn, delta, nd_time, s_nd_time, er_lambda, mc3_iterations, proposal_width)
}

...
Zhu23ABS_tafc_cpp <- function(start_point, trial_fdbk, distr_name, mc3_iterations, n_chains, dec_bdry, discrim, prior_on_resp, delta, nd_time, s_nd_time, er_lambda, proposal_width) {
    .Call(`_samplr_Zhu23ABS_tafc_cpp`, start_point, trial_fdbk, distr_name, mc3_iterations, n_chains, dec_bdry, discrim, prior_on_resp, delta, nd_time, s_nd_time, er_lambda, proposal_width)
}

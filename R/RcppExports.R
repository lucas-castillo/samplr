...
Zhu23ABS_cpp <- function(task_id, trial_stim, distr_name, proposal_width, n_chains, provided_start_point, stop_rule, nd_time, s_nd_time, lambda, prior_on_resp, stim_depend = TRUE, mc3_iterations = 1000L, dec_bdry = 0, discrim = 0) {
    .Call(`_samplr_Zhu23ABS_cpp`, task_id, trial_stim, distr_name, proposal_width, n_chains, provided_start_point, stop_rule, nd_time, s_nd_time, lambda, prior_on_resp, stim_depend, mc3_iterations, dec_bdry, discrim)
}

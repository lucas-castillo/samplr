...
* **[Autocorrelated Bayesian Sampler](../reference/Zhu23ABS.html)**: In ABS samples originate from an MCMC algorithm [see @zhu2024AutocorrelatedBayesianSampler]. See the [Simulations of the Autocorrelated Bayesian Sampler](Simulations-of-the-Autocorrelated-Bayesian-Sampler.html) vignette.
